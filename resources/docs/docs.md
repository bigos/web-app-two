...
The `home-routes` handler in the `web-app-two.routes.home` namespace
...
The `home-page` function will in turn call the `web-app-two.layout/render` function
...
The routes are aggregated and wrapped with middleware in the `web-app-two.handler` namespace:
...
Request middleware functions are located under the `web-app-two.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `web-app-two.dev-middleware` namespace found in
